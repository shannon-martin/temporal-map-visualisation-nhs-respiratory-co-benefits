...
[The NHS health boards (scotland)](https://data-stirling-council.hub.arcgis.com/datasets/stirling-council::open-data-nhs-health-boards-scotland/about) data was obtained from Stirling Council via its Open Data portal. This data contains the boundaries of each health board area and was used as a vector layer in QGIS. This datas contains public sector information licensed under the [UK Open Government Licence v3.0](https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/) and contains Ordnance Survey data © Crown copyright and database right 2024.
